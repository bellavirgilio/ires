...
public class PathManager : MonoBehaviour {
    ...
    void Start()
    {
        ...
        slowdownPathDistance = 30; // placeholder
        continuePathDistance = 233.0574f;
        nonstopPathDistance = 300; // placeholder
        ...
        Tween initial = transform.DOPath(waypoints4, nonstopPathTime, pathType).SetLookAt(0.01f);
    ...
    void Update() {
        ...
        waypoints3 = new[] {
            stop,
            new Vector3(-0.5429688f,0.5f,-38.03741f),
            new Vector3(-0.90625f,0.5f,-40.88074f),
            new Vector3(-3.402344f,0.5f,-42.45447f),
            new Vector3(-6.457031f,0.5f,-42.87268f),
            new Vector3(-23.32813f,0.5f,-42.41516f),
            new Vector3(-32.60156f,0.5f,-40.63574f),
            new Vector3(-36.08203f,0.5f,-39.28369f),
            new Vector3(-40.13672f,0.5f,-37.08124f),
            new Vector3(-43.65625f,0.5f,-34.58752f),
            new Vector3(-47.67969f,0.5f,-30.06952f),
            new Vector3(-50.73828f,0.5f,-25.1709f),
            new Vector3(-51.85156f,0.5f,-19.78284f),
            new Vector3(-52.64453f,0.5f,-13.20251f),
            new Vector3(-52.57813f,0.5f,13.17505f),
            new Vector3(-51.83594f,0.5f,20.64825f),
            new Vector3(-49.5f,0.5f,27.2572f),
            new Vector3(-44.98828f,0.5f,32.98553f),
            new Vector3(-39.89453f,0.5f,37.48236f),
            new Vector3(-33.46484f,0.5f,40.55725f),
            new Vector3(-26.43164f,0.5f,42.14038f),
            new Vector3(-17.91406f,0.5f,42.48737f) };
