...
public class SensorPathManager : MonoBehaviour {
    ...
    private bool sensed; // becomes true OnCollisionEnter

    // keeps track of how many times pedestrian enters collider
    ...
    void Update()
    {
        // IF THE PEDESTRIAN IS IN THE COLLIDER
        if (sensed)
        {
            //Debug.Log("Pedestrian sensed");
            sensed = true;
