...
// old sensor path manager, includes stopwatch

public class SensorPathManagerTest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (currentSpeed < 0.000001f && currentSpeed > -0.000001f && transformCheck > 0.0f)
        {
            GreenLights();
        }
